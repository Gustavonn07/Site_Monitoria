...
export const Home = () => {
  return (
    <div className="w-full flex relative overflow-hidden bg-primary-800">
      <h1 className='absolute top-16 left-1/2 -translate-1/2 z-50 text-4xl font-medium text-gray-300 bg-primary-600 shadow-lg px-5 py-3 rounded-lg'>Selecione sua turma</h1>

      <div
        className="w-1/2 hover:scale-105 duration-150 h-screen bg-cover bg-center flex justify-center items-center relative group"
        style={{
      ...
      >
        ...
        <h2 className='text-white text-4xl font-bold z-20'>Programação 02</h2>
      ...
      <div
        ...
        <h2 className='text-white text-4xl font-bold z-20'>Autoração Multimídia 02</h2>
