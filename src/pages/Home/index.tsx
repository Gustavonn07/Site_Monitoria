...
export const Home = () => {
  ...
  return (
    <div className="w-full flex md:flex-row flex-col relative overflow-hidden bg-primary-800">
      <h1 className="absolute top-16 left-1/2 -translate-1/2 z-50 text-sm sm:text-base font-medium text-gray-300 bg-primary-600 shadow-lg px-4 py-2 rounded-sm">
        Selecione sua turma
      </h1>
      ...
      {!viewport.isMobile ? (
        <>
          ...
          >
            ...
            <h2 className="text-white text-2xl lg:text-4xl font-bold z-20 mb-10">
              Programação 02
            </h2>
